...
@shared_task
def random_auto_image_tweeter_process(imagepath='assets/img/thestoicphilo_media_template.png',
    ...
    try:
        ...
        if tweet is not None:
            ...
            full_filename = write_on_image(imagepath=imagepath, fontpath=fontpath, imagename=imagename, text=text)
